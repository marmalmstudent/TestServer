...
public class NPCHandler {
	...
	NPCHandler() {
		...
		loadNPCList("./src/config/npc.cfg");
		loadNPCDrops("./src/config/npcdrops.cfg");
		loadAutoSpawn("./src/config/autospawn.cfg");
	}
	...
	public void process() {
		...
		for (int i = 0; i < maxNPCs; i++) {
			...
			case 1591:
			case 1592:
			    npcs[i].animNumber = 91; //Dragons: KBD,blue,green,bronze,iron,steel,red,black
			    break;
			case 82:
			case 83:
			case 84:
			...
			case 752:
			case 1472:
			    npcs[i].animNumber = 64; //Demons lesser,greater,black
			    break;
			case 100:
			case 102:
			    npcs[i].animNumber = 309; //Goblins unarmed
			    break;
			case 101:
			    npcs[i].animNumber = 310; //Goblins w/ spear
			    break;
			case 2262:
			    if (misc.random2(10) <= 3) //this is the time delay
				{
					...
					{
					    npcs[i].textUpdate = "Welcome to TestServer";
					}
				    else
					{
					    npcs[i].textUpdate = "Welcome to Testserver";
			    ...
			    break;
					...
					} else if (npcs[i].npcType == 50 || npcs[i].npcType == 55 || npcs[i].npcType == 941 || npcs[i].npcType == 1590 || npcs[i].npcType == 1591 || npcs[i].npcType == 1592 || npcs[i].npcType == 53 || npcs[i].npcType == 54) {
						npcs[i].animNumber = 91; //Dragons: KBD,blue,green,bronze,iron,steel,red,black
					} else if (npcs[i].npcType == 82 || npcs[i].npcType == 83 || npcs[i].npcType == 84 || npcs[i].npcType == 677 || npcs[i].npcType == 752 || npcs[i].npcType == 1472) {
						npcs[i].animNumber = 64; //Demons: lesser,greater,black
					} else if (npcs[i].npcType == 100 || npcs[i].npcType == 102) {
						npcs[i].animNumber = 309; //Goblins unarmed
					} else if (npcs[i].npcType == 101) {
						npcs[i].animNumber = 310; //Goblins w/ spear
					}
					...
					if (npcs[i].npcType == 1451) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to the shops";
						}
					}
					if (npcs[i].npcType == 33) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Tele to shops";
						}
					}
					...
					if (npcs[i].npcType == 945) { // Guide
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Pickup that book and torch, then light the book with the torch! ";
						}
					}
					...
					if (npcs[i].npcType == 535) { // fairy - white armour shop keper
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Shops are a subject to change";
						}
					}
					...
					if (npcs[i].npcType == 1199) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "Rules will be implemented";
						}
					}

					if (npcs[i].npcType == 611) {
						if (misc.random2(30) == 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "TestServer is hosted by localhost";
						}
					}
					...
					if (npcs[i].npcType == 2168) {
						if (misc.random2(50) >= 1) {
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I sell barrows equipment";
						}
					}
					else if (npcs[i].npcType == 1552)
					{
						if (misc.random2(50) <= 3) //this is the time delay
						{
							npcs[i].updateRequired = true;
							npcs[i].textUpdateRequired = true;
							npcs[i].textUpdate = "I sell rare items";
						}
					}
		      ...
		      npcs[i].textUpdate = "Welcome to TestServer";
					...
					if (npcs[i].actionTimer == 0 && npcs[i].DeadApply == false && npcs[i].NeedRespawn == false) {
						...
						if (npcs[i].npcType == 3200) {
							...
							npcs[i].animNumber = 92; //Dragons: KBD,blue,green,bronze,iron,steel,red,black
						} else if (npcs[i].npcType == 82 || npcs[i].npcType == 83 || npcs[i].npcType == 84 || npcs[i].npcType == 677 || npcs[i].npcType == 752 || npcs[i].npcType == 1472) {
							npcs[i].animNumber = 67; //Demons: lesser,greater,black
						} else if (npcs[i].npcType == 100 || npcs[i].npcType == 102 || npcs[i].npcType == 101) {
							npcs[i].animNumber = 313; //Goblins
						} else {
							npcs[i].animNumber = 0x900; //human dead 0x900
						}
						npcs[i].updateRequired = true;
				...
				for (int i = 0; i <= Maxi; i++) {
					if (server.itemHandler.DroppedItemsID[i] > 0) {
						...
						if(npcs[NPCID] != null && server.playerHandler.players[Play] != null && server.playerHandler.players[GetNpcKiller(NPCID)] != null) {
							...
							{
								ItemHandler.addItem(2412, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2661, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2663, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
							if(npcs[NPCID].npcType == 53) 
							{
								ItemHandler.addItem(2414, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2653, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2655, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
							if(npcs[NPCID].npcType == 1590) 
							{
								ItemHandler.addItem(2615, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2617, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2619, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
							if(npcs[NPCID].npcType == 941)
							{
								ItemHandler.addItem(2413, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2669, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(2671, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
							if(npcs[NPCID].npcType == 3200) 
							{
								ItemHandler.addItem(1042, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
								ItemHandler.addItem(1048, npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
							...
							if(npcs[NPCID].npcType == 2745) //CHANGE 23 TO AN NPC ID OF YOUR CHOICE
							{
								ItemHandler.addItem(Item2.randomblackdrop(), npcs[NPCID].absX, npcs[NPCID].absY, 1, GetNpcKiller(NPCID), false);
							}
				...
				if (RingOfLife == true && EnemyHP <= (int)((double)((double)EnemyMaxHP / 10.0) + 0.5)) {
					...
					if (server.playerHandler.players[Player].IsDead == true) {
						...
						if (npcs[NPCID].npcType == 81 || npcs[NPCID].npcType == 397 || npcs[NPCID].npcType == 1766 || npcs[NPCID].npcType == 1767 || npcs[NPCID].npcType == 1768) {
							...
							npcs[NPCID].animNumber = 412; //human attack 0x326
						}
	...
	public int getLevelForXP(int exp)
	{
		...
		for (int lvl = 1; lvl <= Player.maxStatLevel; lvl++) {
			points += Math.floor((double)lvl + 300.0 * Math.pow(2.0, (double)lvl / 14.0));
			//Old value: Math.floor((double)lvl + 300.0 * Math.pow(2.0, (double)lvl / 7.0));
			output = (int)Math.floor(points / 1);
			// Old value: (int)Math.floor(points / 4)
			if (output > exp)
				return lvl;
		}
		return 0;
