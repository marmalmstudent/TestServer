...
{
	/* Max stats */
	public static int maxStatLevel = 40; //no higher than 200 or combat level won't work
	public static int maxStatXP = 39593;
	/*Thieving variables*/
	public long lastStun, stunDelay; //used in thieving atm.
	/*Firemaking variables*/
	public long lastFireLightAnim; //firemaking
	public boolean isLighting;
	public int lightLogsID;
	...
	public Player(int _playerId) {
	  ...
	  pBeard=0;*/
		...
		teleportToX = 3094;//3072;
		teleportToY = 3106;//3312;
	...
	public int maxItemAmount = reallybig(2147483647);
	...
	public int getLevelForXP(int exp)
	{
		int points = 0;
		int output = 0;
		for (int lvl = 1; lvl <= maxStatLevel; lvl++)
		{
			points += Math.floor(lvl + 300.0 * Math.pow(2.0, (double)lvl / 7.0)) / 4;
